...
public class MusicTrack extends Node {
   ...
   MusicTrack(Buffer var1) {
      ...
      var51.writeInt(6);
      var51.method5481(var2 > 1?1:0);
      var51.method5481(var2);
      var51.method5481(var3);
      var1.offset = var13;
      int var52 = 0;
      int var53 = 0;
      int var54 = 0;
      ...
      for(int var60 = 0; var60 < var2; ++var60) {
         ...
         while(true) {
            while(true) {
               int var63 = var1.method5514();
               var51.method5495(var63);
               ...
               if(var64 == 7) {
                  ...
                  var51.writeByte(47);
                  var51.writeByte(0);
                  var51.method5491(var51.offset - var61);
                  continue label221;
               }
   ...
   void method3730() {
      if(this.table == null) {
         ...
         int var5 = var4.method3676();

         int var6;
         for(var6 = 0; var6 < var5; ++var6) {
            var4.method3671(var6);
            var4.method3664(var6);
            var4.method3662(var6);
         }

         label56:
         do {
            while(true) {
               var6 = var4.method3669();
               int var7 = var4.trackLengths[var6];

               while(var7 == var4.trackLengths[var6]) {
                  var4.method3671(var6);
                  int var8 = var4.method3665(var6);
                  if(var8 == 1) {
                     var4.method3660();
                     var4.method3662(var6);
                     continue label56;
                  ...
                  if(var9 == 144) {
                     ...
                     if(var12 > 0) {
                        ...
                        ByteArrayNode var14 = (ByteArrayNode)this.table.method6346((long)var13);
                        if(var14 == null) {
