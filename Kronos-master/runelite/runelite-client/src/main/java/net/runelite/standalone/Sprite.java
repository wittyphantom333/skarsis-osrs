...
public final class Sprite extends Rasterizer2D implements RSSprite {
   ...
   //TODO: Modified added new constructor
   ...
   public void method6114(int var1, int var2, int var3) {
      ...
      if(var7 > 0 && var6 > 0) {
         method6165(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var5, var4, var7, var6, var8, var9, var3);
      }
   }
   ...
   public void method6112(int var1, int var2, int var3, int var4) {
      if(var3 == 256) {
         ...
         if(var8 > 0 && var7 > 0) {
            method6113(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var6, var5, var8, var7, var9, var10, var3, var4);
         }
      }
   }
   ...
   public void method6110(int var1, int var2, int var3, int var4) {
      if(var3 > 0 && var4 > 0) {
         ...
         method6111(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
      }
   }
   ...
   public void method6120(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         ...
         if(var5 == 256) {
            method6121(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6);
         } else {
            method6118(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5);
         }
   ...
   public void method6159(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method6109(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   public void method6102(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method6107(Rasterizer2D.Rasterizer2D_pixels, this.pixels, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   public void method6213(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         ...
         method6116(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
      }
   }
   ...
   public void method6117(int var1, int var2, int var3) {
      ...
      if(var7 > 0 && var6 > 0) {
         if(var3 == 256) {
            method6106(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9);
         } else {
