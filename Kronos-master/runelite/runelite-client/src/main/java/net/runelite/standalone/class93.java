...
public class class93 {
   ...
   static {
      field1234 = new BigInteger("80782894952180643741752986186714059433953886149239752893425047584684715842049");
         ...
         while(true) {
            ...
            if(var17 == var4 && var16 >= var5 && var16 < var5 + 8 && var15 >= var6 && var15 < var6 + 8) {
               ...
               if(var29 > 0 && var37 > 0 && var29 < 103 && var37 < 103) {
                  ...
                  GrandExchangeOfferAgeComparator.method80(var1, var29, var37, var11, var20 + var7 & 3, var19, var8, var39);
               }
            }
         }
      }
      ...
      if(var0.length == 100 && ByteArrayPool.ByteArrayPool_smallCount < 1000) {
         ...
         if(class86.ByteArrayPool_arrays != null) {
            for(int var1 = 0; var1 < ByteArrayPool.ByteArrayPool_alternativeSizes.length; ++var1) {
               if(var0.length == ByteArrayPool.ByteArrayPool_alternativeSizes[var1] && ByteArrayPool.ByteArrayPool_altSizeArrayCounts[var1] < class86.ByteArrayPool_arrays[var1].length) {
                  class86.ByteArrayPool_arrays[var1][ByteArrayPool.ByteArrayPool_altSizeArrayCounts[var1]++] = var0;
                  return;
               }
            }
         }
