...
public final class BZip2Decompressor {
   ...
   static void method5716(BZip2State var0) {
      ...
      int var13 = var0.field3678;
      var0.field3678 += var10 - var10;
      if(var0.field3678 < var13) {
         ;
      }
   ...
   static void method5717(BZip2State var0) {
      ...
      while(true) {
         while(var26) {
            byte var1 = method5718(var0);
            if(var1 == 23) {
               return;
            }

            var1 = method5718(var0);
            var1 = method5718(var0);
            var1 = method5718(var0);
            var1 = method5718(var0);
            var1 = method5718(var0);
            ...
            int var40 = method5720(3, var0);
            int var41 = method5720(15, var0);
            ...
            for(var38 = 0; var38 < var40; ++var38) {
               ...
               method5722(var0.limit[var38], var0.base[var38], var0.perm[var38], var0.temp_charArray2d[var38], var2, var3, var39);
            ...
            int var52;
            byte var53;
            for(var52 = method5720(var22, var0); var52 > var23[var51]; var52 = var52 << 1 | var53) {
               ++var51;
               var53 = method5721(var0);
            }
            ...
            while(true) {
               ...
               for(var36 = 0; var36 < var47; ++var36) {
                  ...
                  DirectByteArrayCopier.BZip2Decompressor_block[var0.cftab[var1 & 255]] |= var36 << 8;
                  ++var0.cftab[var1 & 255];
               }

               var0.field3697 = DirectByteArrayCopier.BZip2Decompressor_block[var0.originalPointer] >> 8;
               var0.nblocks_used = 0;
               var0.field3697 = DirectByteArrayCopier.BZip2Decompressor_block[var0.field3697];
               var0.su_ch2 = (byte)(var0.field3697 & 255);
               var0.field3697 >>= 8;
               ++var0.nblocks_used;
               var0.field3715 = var47;
               method5716(var0);
               if(var0.field3715 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
                  var26 = true;
                  break;
               }
   ...
   public static int method5715(byte[] var0, int var1, byte[] var2, int var3, int var4) {
      ...
      synchronized(BZip2Decompressor_state) {
         ...
         BZip2Decompressor_state.field3678 = 0;
         method5717(BZip2Decompressor_state);
