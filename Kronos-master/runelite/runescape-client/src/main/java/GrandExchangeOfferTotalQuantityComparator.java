...
final class GrandExchangeOfferTotalQuantityComparator implements Comparator {
	...
	static final void method105(class185 var0) {
		...
		if (class185.field2302 == var0) {
			...
			TileItem tileItem;
			if (class185.removeGroundItem == var0) { //remove ground item
				var37 = var1.readByteA(); //tile hash
				var38 = (var37 >> 4 & 7) + class40.field326; //local x
				var4 = (var37 & 7) + WorldMapSection2.field195; //local y
				var5 = var1.readLEShortA(); //item id
				if (var38 >= 0 && var4 >= 0 && var38 < 104 && var4 < 104) {
					NodeDeque queue = Client.groundItems[WorldMapRectangle.plane][var38][var4];
					if (queue != null) {
						for (tileItem = (TileItem) queue.last(); tileItem != null; tileItem = (TileItem) queue.previous()) {
							if ((var5 & 32767) == tileItem.id) {
								tileItem.remove();
								break;
							}
						}
				...
				if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
					...
					Client.groundItems[WorldMapRectangle.plane][var5][var6].addFirst(tileItem);
