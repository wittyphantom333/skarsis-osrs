...
public class WorldMapCacheName {
	...
	static final void updateItemPile(int localX, int localY) {
		NodeDeque var2 = Client.groundItems[WorldMapRectangle.plane][localX][localY];
		if (var2 == null) {
			PacketWriter.scene.removeGroundItemPile(WorldMapRectangle.plane, localX, localY);
		} else {
			long var3 = -99999999L;
			TileItem var5 = null;
			TileItem var6;
			...
			if (var5 == null) {
				...
				long var9 = class267.calculateTag(localX, localY, 3, false, 0);
				PacketWriter.scene.newGroundItemPile(WorldMapRectangle.plane, localX, localY, MusicPatchPcmStream.getTileHeight(localX * 128 + 64, localY * 128 + 64, WorldMapRectangle.plane), var5, var9, var12, var11);
			}
		}
	}
}
